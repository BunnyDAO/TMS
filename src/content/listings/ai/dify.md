...
name: "Dify"
slug: "dify"
tagline: "Open-source platform for building LLM apps with visual workflows"
description: "Dify is an open-source LLM application development platform that combines visual workflow building, RAG pipelines, agent capabilities, and model management in a single interface. It enables both technical and non-technical users to build production-grade AI applications."
category: "ai"
subcategory: "agents"
tags: ["llm-platform", "workflow", "rag", "open-source", "visual-builder"]
...
- **Latest release (late March 2026)** — The most recent release continues to expand model integrations, RAG improvements, workflow capabilities, and platform stability.
