...
name: "ChatGPT"
slug: "chatgpt"
tagline: "OpenAI's AI assistant — GPT-4.1, o3 reasoning, Codex coding agent, and the most popular AI interface"
description: "ChatGPT is OpenAI's flagship conversational AI, used by hundreds of millions of people. The latest models include GPT-4.1 (fast multimodal), o3 (deep reasoning), o4-mini (efficient reasoning), and Codex (autonomous coding agent). Features include real-time web search, code execution, image generation, Canvas editing, custom GPTs, and voice mode."
category: "ai"
subcategory: "llms"
tags: ["llm", "gpt-4", "o3", "codex", "reasoning", "multimodal", "openai", "conversational-ai", "coding-agent"]
...
1. Visit [chatgpt.com](https://chatgpt.com) and sign up for a free account — you get GPT-4.1 mini access immediately.
2. Upgrade to ChatGPT Plus ($20/mo) for GPT-4.1, o3, o4-mini, image generation, and higher usage limits.
3. For Codex and the full model lineup, upgrade to ChatGPT Pro ($200/mo).
4. For API access, go to [platform.openai.com](https://platform.openai.com) to get your API key.
...
- **Codex (codex-1)** — OpenAI's autonomous coding agent. Runs in a cloud sandbox, reads your full repo, writes and edits code, runs tests, and creates PRs on GitHub. Works asynchronously — assign tasks and come back to finished work. Based on o3, fine-tuned for software engineering.
...
- **Multimodal I/O** — Text, images, audio, video, and file uploads in a unified chat interface. Generate images inline.
...
- **Agentic features** — Browse the web, perform multi-step deep research, and complete tasks autonomously.
