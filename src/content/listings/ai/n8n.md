...
name: "n8n"
slug: "n8n"
tagline: "Open-source workflow automation platform with AI agent capabilities"
description: "n8n is a fair-code workflow automation platform that lets you connect any app or API with a visual node-based editor. With built-in AI agent nodes, it enables building sophisticated automation workflows that combine traditional integrations with LLM-powered decision making."
category: "ai"
subcategory: "agents"
tags: ["automation", "workflow", "agents", "integrations", "no-code"]
...
1. Self-host n8n via Docker (`docker run -p 5678:5678 n8nio/n8n`) or sign up for n8n Cloud at [n8n.io](https://n8n.io).
...
- **Frequent releases** with the latest update in late February 2026, continuing to expand AI node capabilities and integration coverage.
