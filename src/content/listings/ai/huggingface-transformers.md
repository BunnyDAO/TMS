...
- **Latest release (April 2026)** — The most recent release adds support for new model architectures, hardware backends, and continued refinements to the pipeline API.
