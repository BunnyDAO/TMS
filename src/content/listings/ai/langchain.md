...
name: "LangChain"
slug: "langchain"
tagline: "Framework for building LLM-powered applications and agents"
description: "LangChain is the most widely adopted framework for building applications powered by large language models. It provides modular abstractions for chains, agents, retrieval, and memory, along with LangSmith for observability and LangGraph for complex agent orchestration."
category: "ai"
subcategory: "agents"
tags: ["framework", "agents", "rag", "llm-apps", "developer-tools"]
...
- **Active development** with frequent releases — the latest dropped on February 23, 2026, continuing to refine agent primitives and LangGraph capabilities.
