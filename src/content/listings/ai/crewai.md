...
name: "CrewAI"
slug: "crewai"
tagline: "Framework for orchestrating autonomous AI agent teams"
description: "CrewAI is a Python framework for orchestrating teams of autonomous AI agents that collaborate to complete complex tasks. By assigning roles, goals, and tools to individual agents, CrewAI enables sophisticated multi-agent workflows with built-in delegation and task management."
category: "ai"
subcategory: "agents"
tags: ["multi-agent", "framework", "orchestration", "autonomous", "python"]
...
- **Latest release (late February 2026)** — The most recent release brings continued refinements to agent orchestration, tool reliability, and enterprise deployment options.
