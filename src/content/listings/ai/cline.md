...
name: "Cline"
slug: "cline"
tagline: "Open-source autonomous coding agent in VS Code — approve every action with human-in-the-loop"
description: "Cline is an open-source autonomous coding agent that runs as a VS Code extension. It can create and edit files, run terminal commands, browse the web, use MCP servers, and complete complex multi-step tasks. Every action requires your explicit approval, giving you full control. Supports Claude, GPT-4, Gemini, DeepSeek, local models via Ollama, and many other providers."
category: "ai"
subcategory: "coding"
tags: ["coding-agent", "vscode", "autonomous", "open-source", "agentic", "mcp", "multi-provider", "human-in-the-loop"]
...
- **Latest release (late February 2026)** — The most recent release includes continued improvements to MCP reliability, provider compatibility, and agent task execution.
