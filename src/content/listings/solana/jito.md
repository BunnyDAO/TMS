...
name: "Jito"
slug: "jito"
tagline: "Solana's liquid staking + MEV infrastructure — JitoSOL earns enhanced yields, Block Engine powers the network"
description: "Jito serves two critical roles in the Solana ecosystem: liquid staking (JitoSOL) and MEV infrastructure (Jito Block Engine). JitoSOL is the largest liquid staking token on Solana, earning enhanced yields from both staking rewards and MEV tips. The Jito Block Engine is the backbone of Solana's block building — Jupiter routes MEV-protected trades through Jito bundles, and traders use it for priority transaction inclusion."
category: "solana"
subcategory: "staking"
tags: ["liquid-staking", "mev", "yield", "defi", "validators", "block-engine", "bundles"]
...
1. Visit [jito.network](https://jito.network) and connect your Phantom or Backpack wallet.
